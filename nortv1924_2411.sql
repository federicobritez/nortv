...
INSERT INTO `EquipoTecnico` VALUES (1,'MQD725',1),(2,'MZT432',2),(3,'LZH732',3),(4,'PTO725',4);
...
CREATE TABLE `ReclamosRealizado` (
  ...
  `idViaComunicacion` int(11) NOT NULL,
  PRIMARY KEY (`idReclamo`,`idAbonado`,`idConexion`),
...
INSERT INTO `ReclamosRealizado` VALUES (3,15468,127,'0000-00-00 00:00:00',1);
...
INSERT INTO `Tarea` VALUES (1,'Cambio Decodificador'),(2,'Cambio Bajada'),(3,'Cableado Domicilio'),(4,'Calibrar Señal'),(5,'Quitar Bajada');
...
CREATE TABLE `TareaPorTrabajo` (
  ...
  PRIMARY KEY (`idTarea`,`Trabajo_idTrabajo`),
  KEY `fk_TareaPorTrabajo_Tarea1_idx` (`idTarea`),
  KEY `fk_TareaPorTrabajo_Trabajo1_idx` (`Trabajo_idTrabajo`),
  ...
  CONSTRAINT `fk_TareaPorTrabajo_Trabajo1` FOREIGN KEY (`Trabajo_idTrabajo`) REFERENCES `Trabajo` (`idTrabajo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Trabajo` (
  ...
  KEY `fk_Trabajo_Tarea1_idx` (`idTarea`),
  ...
  CONSTRAINT `fk_Trabajo_Tarea1` FOREIGN KEY (`idTarea`) REFERENCES `Tarea` (`idTarea`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-24 19:24:45
