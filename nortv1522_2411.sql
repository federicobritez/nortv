...
INSERT INTO `Insumo` VALUES (1,'Cable Exterior','mts'),(2,'Cable Interior','mts'),(3,'decodificador','unidad'),(4,'patchcords 3mts','unidad'),(5,'patchcords 5mts','unidad'),(6,'grampas','unidad');
...
CREATE TABLE `ReclamosRealizado` (
  `idReclamosRealizado` int(11) NOT NULL,
  `fechaReclamo` datetime NOT NULL,
  `idAbonado` int(11) NOT NULL,
  `idConexion` int(11) NOT NULL,
  `idViaComunicacion` int(11) NOT NULL,
  `idReclamo` int(11) NOT NULL,
  PRIMARY KEY (`idReclamosRealizado`),
...
CREATE TABLE `Servicio` (
  ...
  `canalesPeliculas` int(11) DEFAULT NULL,
...
INSERT INTO `Servicio` VALUES (1,500,40,0,0,'','',''),(2,600,40,2,4,'','',''),(3,700,46,4,0,'','','');
...
-- Dump completed on 2016-11-24 15:23:00
